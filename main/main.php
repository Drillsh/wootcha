                  ...
                  <a title="" href="#">
                    ...
                    <div class="css-wg9zzb-ContentPosterBlock e3fgkal1">
                      ...
                      <div class=" e1pon7hn0 css-1hdc5d8-Self-LazyLoadingImg ewlo9840">
                        <img src="" class=" e1pon7hn0 css-1onlrbk-Img-LazyLoadingImg ewlo9841">
                      </div>
                      <!-- 포스터 랭크 -->
                      <div class="css-13ot87v-RankBadge e3fgkal7">1</div>
                    </div>
                    <!-- 6층 설명 -->
                    <div class="css-dmreg0-ContentInfo e3fgkal2">
                      <!-- 영화설명_제목 -->
                      <div class="css-1teivyt-ContentTitle e3fgkal3">영화제목</div>
                      <!-- 영화설명_출시년도 -->
                      <div class="css-6t186m-StyledContentYearAndNation ebeya3l12">2020</div>
                      <!-- 영화설명_평점 -->
