            ...
            <div class="css-ScrollBarContainer e1f5xhlb0">
                ...
                <div class="css-ScrollBar e1f5xhlb1">
                    ...
                    where review_num = $review_number;";
                                    ...
                                    ?>
                                    <!--DB 결과 수    -->
                                    <input type="hidden" name="result_count" id="result_count"
                                           value="<?= $result_count ?>">
                                    <li class="css-MainList-li e3fgkal0">
                                        <!-- 영화 6층 a -->
                                        <a title="<?= $mv_title ?>" href="#" class="review_dialog_trigger"
                                        ...
                                        <a title="<?= $mv_title ?>" href="#" class="review_dialog_trigger"
                                           onclick="return false;">
                                            ...
                                            <div class="css-dmreg0-ContentInfo e3fgkal2">
                                                ...
                                                <!-- 서브리스트 div 리뷰작성자 -->
                                                <div class="css-1teivyt-ContentShortMemberNick">작성자
                                                    : <?= $user_nickname ?></div>
                                                <!-- 서브리스트 div 영화리뷰 -->
                                ...
                                <a title="<?= $mv_title ?>" href="#" onclick="return false;">
                                    ...
                                    <div class="css-wg9zzb-ContentPosterBlock e3fgkal1">
                                        ...
                                        <div class=" e1pon7hn0 css-1hdc5d8-Self-LazyLoadingImg ewlo9840">
                                            <!-- 장르별리스트 img 설정 -->
                                            <img src="<?= $mv_img_path ?>"
                                                 class=" e1pon7hn0 css-1onlrbk-Img-LazyLoadingImg ewlo9841" alt="">
                                            <!-- 장르별리스트 img 스템프 -->
                                            <div class="ottBadge css-cq1n1p-OttBadge e3fgkal8" src="" alt="왓챠!">dd
                                            </div>
                                        </div>
                                    </div>
                                    <!-- 장르별리스트 div 영화설명 -->
