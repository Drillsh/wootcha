    ...
    <div class="modal_content_review">
        <div class="content_left_review">
            ...
            <div class="modal_content_review_header">
                ...
                <a href="http://<?=$_SERVER['HTTP_HOST']?>/wootcha/mypage/mypage_index.php?userpage_user_num=<?=$review_writer_num?>">
            ...
            <h2 class="title"><?=$movie_subject?></h2>
            ...
            ?>
                <span>
                    <form action="#" method="post" class="review_like_form">
                        ...
                        <label for="like_checkbox<?=$while_num?>">
                            <img
                                src="http://<?=$_SERVER['HTTP_HOST']?>/wootcha/mypage/img/<?=$like_img?>.png"
                                alt=""
                ...
                <span>
                    ...
                    <label for="checkbox<?=$while_num?>">
                        <img
                            src="http://<?=$_SERVER['HTTP_HOST']?>/wootcha/mypage/img/comments.png"
                            alt="">&nbsp;
