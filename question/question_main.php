            ...
            if ($first_page < 1) {
             $first_page = 1;
              ...
              $first_page = $total_page - $page_scale + 1;
                            ...
                            $url = "/wootcha/question/question_main.php?y=$y&m=$m";
                            if ($search != '') {
                            ...
                            <div id="listwrite">
                             <input class="listwrite" type="image" src="./img/list.png" onclick="location.href='question_main.php'">
                             <input class="listwrite" type="image" src="./img/write.png" onclick="location.href='write_edit_form.php'">
                            </div>
                      </div>
                      <!-- </ul> page	    	 -->
